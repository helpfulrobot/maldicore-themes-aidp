...
<% end_if %>
<% if canPost %>
	<p class="forum_start_new_topic"><a href="{$Link}starttopic" title="<% _t('Forum_ss.NEWTOPIC','Click here to start a new topic') %>"><img src="forum/images/forum_startTopic.gif" alt="<% _t('Forum_ss.NEWTOPICIMAGE','Start new topic') %>" /></a></p>
<% end_if %>
